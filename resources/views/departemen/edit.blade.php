    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                name="kode_dept" placeholder="Kode Divisi" readonly>
              </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $departemen->nama_dept }}" id="nama_dept" class="form-control" name="nama_dept" placeholder="Nama Divisi">
              </div>
        </div>
    </div>
