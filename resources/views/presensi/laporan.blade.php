    ...
    <div class="container-xl">
        <div class="row">
            <div class="col-6">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ url('presensi/cetaklaporan') }}" id="frmLaporan" target="_blank" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <div class="form-group">
                                    <select name="nrp" id="nrp" class="form-select">
                                        <option value="">Pilih Prajurit / Pegawai</option>
                                        @foreach ($karyawan as $d)
                                            <option value="{{ $d->nrp }}">{{ $d->nama_lengkap }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <button type="submit" name="exportexcel" class="btn btn-success w-100">
                                        ...
                                        <path d="M5 12v-7a2 2 0 0 1 2 -2h7l5 5v4" /><path d="M4 15l4 6" /><path d="M4 21l4 -6" />
        ...
        $(function(){
            $("#frmLaporan").submit(function(e){
                ...
                if(bulan == ""){
                    ...
                    Swal.fire({
                        title: 'Data Kosong',
                        text: 'Anda Belum Memilih Prajurit / Pegawai',
                        icon: 'warning',
                        confirmButtonText: 'OK'
                        }).then((result) => {
                            $("#nrp").focus();
